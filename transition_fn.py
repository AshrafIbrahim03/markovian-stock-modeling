...
def transition_fn_by_randomized_vector(current_state: State,
                                       validator: StateValidator) -> pd.Series:
...
def transition_fn_by_lin_reg(current_state: State,
                             validator: StateValidator) -> pd.Series:
